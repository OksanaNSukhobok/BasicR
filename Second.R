...
# Matrix - жва измерения, строки одинаковой длины
...
# Data frame може сочетать векторы одинаковой длины
...
diamonds <- read.csv("C:/Work/Data Analyst/BasicR/P1_diamonds.csv", header = TRUE)
head(diamonds)
